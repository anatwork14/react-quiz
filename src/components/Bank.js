...
function reducer(state, action) {
  ...
  switch (action.type) {
    ...
    case "loan":
      const isAbleToLoan = state.loan ? false : true;
      return {
        ...state,
        loan: isAbleToLoan ? action.payload : state.loan,
        balance: isAbleToLoan ? state.balance + action.payload : state.balance,
      };
    case "deposit":
    ...
    case "payloan":
      ...
      break;
    case "closeAccount":
      return state.loan ? state : initialState;
    default:
